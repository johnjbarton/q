...
var global = (function(){return this;})();  // does not work in 'use strict'
global = window;
...
*/    // browsers
    if (typeof MessageChannel !== "undefined") {
        ...
        nextTick = function (task) {
            ...
            if (global.Cause) {
              var causalLink;
              if (Cause && Cause.externalCause) {
                causalLink = {name: Cause.externalCause};
                externalCause = null;
              } else {
                causalLink = head;
              }
              tail.cause = new Cause(causalLink);
            }
...
function when(value, fulfilled, rejected) {
    ...
    function _fulfilled(value) {
        try {
            if (global.Cause && typeof value === 'undefined') {
